...
public class WarehouseItemPrint implements Printable {

	/**序号 */
	private  String code="14843";
	/**物料 */
	private  String item="80340G211L";
	/**仓库 */
	private  String cwar="CRB02";
	/**物料说明 */
	private  String itemDsca="铝管";
	...
	public WarehouseItemPrint(String printerName) {
		super();
		this.printerName = printerName;
	}

	public WarehouseItemPrint() {
		super();
	}
...
//				 打印起点坐标
		...
		switch (pageIndex) {
			case 0:
					...
					g2.setFont(font);
					g2.drawString("物料标签", (float) (x + 45),
						(float) (y + 25));
					font = new Font("微软雅黑", Font.BOLD, 8);
					g2.setFont(font);
					g2.drawString("仓库:"+cwar, (float) (x ),
						(float) (y + 80));
//					g2.drawString("物料："+item, (float) (x+ 60),
//							(float) (y+80));
					g2.drawString("描述:"+itemDsca, (float) (x+ 65),
						(float) (y+80));
//				g2.drawString("标签编号："+ code, (float) (x+ 140),
//						(float) (y+100));
				   CodeAndPrint codeAndPrint = new CodeAndPrint();
				String filename = "C:\\toolsZ\\production\\codeZ\\11.jpg";
				   codeAndPrint.printDimensionalCode(item,filename);
					Image Img = null;
					try {
	...
	public static void main(String[] args) {
		...
		book.append(new WarehouseItemPrint(), pf);
