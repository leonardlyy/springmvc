...
public class WarehouseClotPrint2 implements Printable {
	...
	public WarehouseClotPrint2(String printerName) {
		super();
		this.printerName = printerName;
	}

	public WarehouseClotPrint2() {
		super();
	}
...
//				 打印起点坐标
		...
		switch (pageIndex) {
			case 0:
				...
				g2.setFont(font);
				g2.drawString("批次标签", (float) (x + 45),
						(float) (y + 25));
				font = new Font("微软雅黑", Font.BOLD, 8);
					g2.setFont(font);
					g2.drawString("仓库："+cwar, (float) (x + 5),
						(float) (y + 80));
					g2.drawString("物料："+item.trim(), (float) (x+ 60),
							(float) (y+80));
//					g2.drawString("批次："+clot, (float) (x+ 60),
//						(float) (y+55));
	...
	public static void main(String[] args) {
		...
		book.append(new WarehouseClotPrint2(), pf);
